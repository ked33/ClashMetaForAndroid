...
extern int (*selector_updated_func)(void *selector_update_interface, const char *group, const char *selected);
...
extern int selector_updated(void *selector_update_interface, char *group, char *selected);
